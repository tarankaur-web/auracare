...
import AuthPage from './AuthPage'; // adjust path if needed
import '../App.css';
        ...
        >
          ...
          >
            <div className="hero-content max-w-3xl mx-auto">
              ...
              <p
                className="hero-subtitle mt-3 text-lg"
                style={{ color: '#2a4850' }}
              >
                Your personalized mental wellness companion designed
                specifically for teenagers. Take assessments, track your mood,
                chat with AI support, and get the help you deserve all in a
                safe, private space.
              </p>
              ...
              <div className="hero-stats flex gap-8 justify-center mt-6 flex-wrap">
                <div className="stat">
                  ...
                  <div className="stat-label text-sm">
                    of teens need mental health support
                  </div>
                </div>
                ...
                {[
                  {
                    ...
                    title: 'Mood Tracking',
                    desc:
                      'Track your daily emotions and discover patterns with beautiful visualizations',
                  },
                  {
                    icon: '🤖',
                    title: 'AI Support Chat',
                    desc:
                      '24/7 AI companion trained to provide empathetic support and coping strategies',
                  },
                  {
                    icon: '📋',
                    title: 'Mental Health Assessments',
                    desc:
                      'Evidence-based screenings for depression, anxiety, and stress levels',
                  },
                  {
                    icon: '📱',
